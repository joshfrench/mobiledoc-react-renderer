...
const unknownCardHandler = ({ payload }) => <div>
  <img src={payload.src} />
  <MobiledocRenderer mobiledoc={payload.mobiledoc} sectionElementRenderer={{ p: 'small' }} />
</div>;
...
const renderer = React.createElement(MobiledocRenderer, { mobiledoc, unknownCardHandler });

const root = document.createElement('div');

suite('Mobiledoc Renderer', function() {
  benchmark('original 2-stage rendering', function () {
