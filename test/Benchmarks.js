...
const renderer = React.createElement(MobiledocRenderer, { mobiledoc, cards: [ImageCard]});

const root = document.createElement('div');

const suite = new Benchmark.Suite('Mobiledoc Rendering');
suite.add('2-pass rendering', () => {
